...
class SphereRaysampler(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        rays_directions_world = rays_directions_world_full[:, (chunksize * chunk_idx):(chunksize * (chunk_idx + 1))]
        ...
        rays_origins_world = rays_origins_world[None].expand(1, real_chunk_size, 3)
        ...
        xy_grid = torch.cuda.FloatTensor([0.5, 0.5])[None, None].expand(1, real_chunk_size, 2)
